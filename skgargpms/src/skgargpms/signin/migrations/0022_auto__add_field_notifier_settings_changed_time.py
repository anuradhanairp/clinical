...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Notifier_Settings.changed_time'
        db.add_column('signin_notifier_settings', 'changed_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 5, 20, 20, 5, 56, 738111)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Notifier_Settings.changed_time'
        db.delete_column('signin_notifier_settings', 'changed_time')
    ...
    models = {
        ...
        'signin.eventsetheader': {
            ...
            'clinic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['signin.Clinic']"}),
            'dateTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 20, 20, 5, 56, 741750)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'signin.notifier_settings': {
            ...
            'changed_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 20, 20, 5, 56, 738111)'}),
