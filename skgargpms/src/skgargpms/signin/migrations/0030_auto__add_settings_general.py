...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('signin_settings_general', (
            ...
            ('argument1', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('argument2', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('argument3', self.gf('django.db.models.fields.CharField')(max_length=16)),
    ...
    models = {
        ...
        'signin.eventsetheader': {
            ...
            'clinic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['signin.Clinic']"}),
            'dateTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 25, 2, 50, 54, 924052)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'signin.settings_general': {
            ...
            'argument1': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'argument2': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'argument3': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
