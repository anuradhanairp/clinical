...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlertConfiguration.alert_retry'
        db.add_column('signin_alertconfiguration', 'alert_retry', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AlertConfiguration.alert_retry'
        db.delete_column('signin_alertconfiguration', 'alert_retry')
    ...
    models = {
        'signin.alertconfiguration': {
            ...
            'dateTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 29, 10, 40, 35, 621893)'}),
        ...
        'signin.alertmaillog': {
            ...
            'dateTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 29, 10, 40, 35, 624698)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'signin.eventsetheader': {
            ...
            'clinic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['signin.Clinic']"}),
            'dateTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 29, 10, 40, 35, 616825)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
