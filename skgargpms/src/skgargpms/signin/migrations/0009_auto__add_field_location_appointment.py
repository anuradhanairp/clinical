...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Location.appointment'
        db.add_column('signin_location', 'appointment', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.appointment'
        db.delete_column('signin_location', 'appointment')
