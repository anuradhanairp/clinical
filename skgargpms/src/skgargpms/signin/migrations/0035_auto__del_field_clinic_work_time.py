...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Clinic.work_time'
        db.delete_column('signin_clinic', 'work_time')


    def backwards(self, orm):
        
        # Adding field 'Clinic.work_time'
        db.add_column('signin_clinic', 'work_time', self.gf('django.db.models.fields.CharField')(default='morning', max_length=32), keep_default=False)
    ...
    models = {
        'signin.alertconfiguration': {
            ...
            'dateTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 2, 4, 9, 2, 800868)'}),
        ...
        'signin.eventsetheader': {
            ...
            'clinic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['signin.Clinic']"}),
            'dateTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 2, 4, 9, 2, 795320)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
