...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('signin_clinic', 'start_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True), keep_default=False)

        # Adding field 'Clinic.end_time'
        db.add_column('signin_clinic', 'end_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True), keep_default=False)
