...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('signin_location', 'timezone', self.gf('django.db.models.fields.CharField')(default='EST', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.timezone'
        db.delete_column('signin_location', 'timezone')
