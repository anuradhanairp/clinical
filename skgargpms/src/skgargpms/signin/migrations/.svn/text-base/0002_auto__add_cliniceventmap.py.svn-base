...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ClinicEventMap'
        db.create_table('signin_cliniceventmap', (
            ...
            ('position', self.gf('django.db.models.fields.IntegerField')(max_length=3)),
        ))
        db.send_create_signal('signin', ['ClinicEventMap'])


    def backwards(self, orm):
        
        # Deleting model 'ClinicEventMap'
        db.delete_table('signin_cliniceventmap')
