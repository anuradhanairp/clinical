...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Notifier_Settings.enable_disbale'
        db.delete_column('signin_notifier_settings', 'enable_disbale')

        # Adding field 'Notifier_Settings.enable_disable'
        db.add_column('signin_notifier_settings', 'enable_disable', self.gf('django.db.models.fields.CharField')(default='Yes', max_length=4), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Notifier_Settings.enable_disbale'
        db.add_column('signin_notifier_settings', 'enable_disbale', self.gf('django.db.models.fields.CharField')(default='Yes', max_length=4), keep_default=False)

        # Deleting field 'Notifier_Settings.enable_disable'
        db.delete_column('signin_notifier_settings', 'enable_disable')
    ...
    models = {
        ...
        'signin.eventsetheader': {
            ...
            'clinic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['signin.Clinic']"}),
            'dateTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 20, 20, 2, 5, 587088)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
