...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Location.provider_required'
        db.add_column('signin_location', 'provider_required', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.provider_required'
        db.delete_column('signin_location', 'provider_required')
