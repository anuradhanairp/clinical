...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlertConfiguration.alert_interv'
        db.add_column('signin_alertconfiguration', 'alert_interv', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AlertConfiguration.alert_interv'
        db.delete_column('signin_alertconfiguration', 'alert_interv')


    models = {
        'signin.alertconfiguration': {
            'Meta': {'object_name': 'AlertConfiguration'},
            'alert_interv': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '3'}),
