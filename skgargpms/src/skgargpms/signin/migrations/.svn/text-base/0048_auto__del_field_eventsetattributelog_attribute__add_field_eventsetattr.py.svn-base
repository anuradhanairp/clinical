...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EventSetAttributeLog.attribute'
        db.delete_column('signin_eventsetattributelog', 'attribute_id')

        # Adding field 'EventSetAttributeLog.attr_map'
        db.add_column('signin_eventsetattributelog', 'attr_map', self.gf('django.db.models.fields.related.ForeignKey')(default='test', to=orm['signin.EventAttributeMap']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'EventSetAttributeLog.attribute'
        raise RuntimeError("Cannot reverse this migration. 'EventSetAttributeLog.attribute' and its values cannot be restored.")

        # Deleting field 'EventSetAttributeLog.attr_map'
        db.delete_column('signin_eventsetattributelog', 'attr_map_id')
