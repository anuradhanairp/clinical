...
class Migration(SchemaMigration):
    ...
    models = {
        'signin.alertconfiguration': {
            ...
            'dateTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 6, 15, 41, 47, 636120)'}),
        ...
        'signin.eventsetheader': {
            ...
            'clinic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['signin.Clinic']"}),
            'dateTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 6, 15, 41, 47, 632956)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
