...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Provider.loc'
        db.add_column('signin_provider', 'loc', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['signin.Location'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Provider.loc'
        db.delete_column('signin_provider', 'loc_id')
    ...
    models = {
        ...
        'signin.eventsetheader': {
            ...
            'clinic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['signin.Clinic']"}),
            'dateTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 1, 5, 56, 46, 634659)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
