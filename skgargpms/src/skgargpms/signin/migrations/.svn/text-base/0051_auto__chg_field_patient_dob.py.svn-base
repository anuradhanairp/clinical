...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Patient.dob'
        db.alter_column('signin_patient', 'dob', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Patient.dob'
        db.alter_column('signin_patient', 'dob', self.gf('django.db.models.fields.DateField')(default=datetime.date(1111, 1, 1)))
