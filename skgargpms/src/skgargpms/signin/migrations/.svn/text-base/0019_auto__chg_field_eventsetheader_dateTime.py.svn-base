...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventSetHeader.dateTime'
        db.alter_column('signin_eventsetheader', 'dateTime', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'EventSetHeader.dateTime'
        db.alter_column('signin_eventsetheader', 'dateTime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        'signin.eventsetheader': {
            ...
            'clinic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['signin.Clinic']"}),
            'dateTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 17, 9, 45, 27, 917395)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
