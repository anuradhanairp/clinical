...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Payment.interrupttype'
        db.add_column('signin_payment', 'interrupttype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['signin.Interrupt'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Payment.interrupttype'
        db.delete_column('signin_payment', 'interrupttype_id')
