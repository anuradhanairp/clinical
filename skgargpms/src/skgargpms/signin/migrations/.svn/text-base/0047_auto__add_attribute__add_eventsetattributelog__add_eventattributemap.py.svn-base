...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('signin_attribute', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')()),
            ('error_message', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('signin', ['Attribute'])

        # Adding model 'EventSetAttributeLog'
        db.create_table('signin_eventsetattributelog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('attribute', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['signin.EventAttributeMap'])),
            ('header', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['signin.EventSetHeader'])),
            ('value', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('signin', ['EventSetAttributeLog'])

        # Adding model 'EventAttributeMap'
        db.create_table('signin_eventattributemap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('attribute', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['signin.Attribute'])),
        ...
        db.send_create_signal('signin', ['EventAttributeMap'])


    def backwards(self, orm):
        
        # Deleting model 'Attribute'
        db.delete_table('signin_attribute')

        # Deleting model 'EventSetAttributeLog'
        db.delete_table('signin_eventsetattributelog')

        # Deleting model 'EventAttributeMap'
        db.delete_table('signin_eventattributemap')
    ...
    models = {
        ...
        'signin.eventsetattributelog': {
            ...
            'attribute': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['signin.EventAttributeMap']"}),
