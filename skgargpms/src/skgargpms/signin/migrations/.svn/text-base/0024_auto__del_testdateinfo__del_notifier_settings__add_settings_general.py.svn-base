...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'Testdateinfo'
        db.delete_table('signin_testdateinfo')
    ...
    def backwards(self, orm):
        ...
        # Adding model 'Testdateinfo'
        db.create_table('signin_testdateinfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('dateTime', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('signin', ['Testdateinfo'])

        # Adding model 'Notifier_Settings'
        db.create_table('signin_notifier_settings', (
            ('changed_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 5, 20, 23, 27, 3, 95062))),
            ('to_mail', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('time_hours', self.gf('django.db.models.fields.IntegerField')(default=2, max_length=16)),
            ('enable_disable', self.gf('django.db.models.fields.CharField')(default='Yes', max_length=4)),
            ('from_mail', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('time_mins', self.gf('django.db.models.fields.IntegerField')(default=10, max_length=16)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('alert_mail_subject', self.gf('django.db.models.fields.CharField')(default='Alert :- Patient {fname} is still waiting to be  processed...', max_length=100)),
        ))
    ...
    models = {
        ...
        'signin.eventsetheader': {
            ...
            'clinic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['signin.Clinic']"}),
            'dateTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 25, 2, 33, 24, 931786)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
