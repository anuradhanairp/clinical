...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlertConfiguration.event_list'
        db.add_column('signin_alertconfiguration', 'event_list', self.gf('django.db.models.fields.CharField')(default='', max_length=300), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AlertConfiguration.event_list'
        db.delete_column('signin_alertconfiguration', 'event_list')
    ...
    models = {
        'signin.alertconfiguration': {
            ...
            'dateTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 2, 15, 41, 3, 412043)'}),
        ...
        'signin.eventsetheader': {
            ...
            'clinic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['signin.Clinic']"}),
            'dateTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 2, 15, 41, 3, 406823)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
