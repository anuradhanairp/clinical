...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('signin_settings_general', (
            ...
            ('argument1', self.gf('django.db.models.fields.CharField')(default='', max_length=16)),
            ('argument2', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
            ('argument3', self.gf('django.db.models.fields.CharField')(default='', max_length=16)),
            ('argument4', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
    ...
    models = {
        ...
        'signin.eventsetheader': {
            ...
            'clinic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['signin.Clinic']"}),
            'dateTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 25, 17, 19, 33, 645515)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
