...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('signin_alertmaillog', (
            ...
            ('waiting_event', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('clinic', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('patient_id', self.gf('django.db.models.fields.IntegerField')()),
            ('patient_firstname', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('patient_lastname', self.gf('django.db.models.fields.CharField')(max_length=32)),
    ...
    models = {
        'signin.alertconfiguration': {
            ...
            'dateTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 6, 15, 46, 59, 801673)'}),
        ...
        'signin.alertmaillog': {
            ...
            'clinic': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'dateTime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'from_addr': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'patient_firstname': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'patient_id': ('django.db.models.fields.IntegerField', [], {}),
            'patient_lastname': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'to_addr': ('django.db.models.fields.CharField', [], {'max_length': '1000'}),
            'waiting_event': ('django.db.models.fields.CharField', [], {'max_length': '32'})
        },
        'signin.clinic': {
        ...
        'signin.eventsetheader': {
            ...
            'clinic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['signin.Clinic']"}),
            'dateTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 6, 15, 46, 59, 798535)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
